...
End-to-end test automation framework for [automationexercise.com](https://automationexercise.com) built with **Playwright** and **TypeScript**, following the Page Object Model pattern. Tests are linked to Jira and failures are automatically reported as bugs. Reports are generated with Allure and the pipeline runs on GitHub Actions.
...
|---|---|---|
| [Playwright](https://playwright.dev) | ^1.44.0 | Browser automation and test runner |
| [TypeScript](https://www.typescriptlang.org) | ^5.4.0 | Static typing |
| [allure-playwright](https://github.com/allure-framework/allure-js) | ^3.0.0 | Allure reporter integration |
| [allure-commandline](https://github.com/allure-framework/allure2) | ^2.29.0 | Allure HTML report generation |
...
All test inputs are stored in [`testData/userData.json`](testData/userData.json) and imported directly into spec files via `resolveJsonModule`.
...
> Allure requires Java to be installed locally for the `allure-commandline` package to generate reports. Download from [adoptium.net](https://adoptium.net).
...
The pipeline is defined in [`.github/workflows/playwright.yml`](.github/workflows/playwright.yml) and runs on **GitHub Actions**.
...
1. Go to the [Actions tab](https://github.com/AsmaaEissa10/QA_Framework_AI_Automation/actions)
2. Click the completed workflow run
3. Scroll to the **Artifacts** section at the bottom
4. Download any of the three artifacts:
   - `playwright-html-report`
   - `allure-results`
   - `allure-html-report`
...
All page objects live in [`pages/`](pages/) and are accessed through [`PoManager`](pages/PoManager.ts).
...
**GitHub:** [github.com/AsmaaEissa10/QA_Framework_AI_Automation](https://github.com/AsmaaEissa10/QA_Framework_AI_Automation)  
**Base URL under test:** [automationexercise.com](https://automationexercise.com)  
**Jira Project:** AEQ — Automation Exercise QA
